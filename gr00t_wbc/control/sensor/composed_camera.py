...
try:
    ...
    print("Warning: opencv-python (cv2) not installed - camera features may be limited")

try:
    import depthai as dai  # noqa
except ImportError:
    print("Warning: depthai not installed - OAK camera support disabled")

try:
    import pyzed.sl as sl  # noqa
except ImportError:
    pass  # ZED SDK optional - silently skip if not installed
...
class ComposedCameraSensor(Sensor, SensorServer):
    ...
    def _instantiate_camera(
        ...
        if camera_type in ("oak", "oak_mono"):
            from gr00t_wbc.control.sensor.oak import OAKConfig, OAKSensor
            ...
            from gr00t_wbc.control.sensor.realsense import RealSenseSensor
            ...
            from gr00t_wbc.control.sensor.zed import ZEDSensor
            ...
            from gr00t_wbc.control.sensor.dummy import ReplayDummySensor
