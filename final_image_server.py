...
if __name__ == "__main__":
    ...
    parser.add_argument('--resolution', type=str, default='848x480', help='Width x height')
    ...
    try:
        ...
        img_shape = [480, 848]
        logger_mp.warning(f'[CONFIG] Invalid --resolution "{args.resolution}", using 848x480')
